...
class UIPropertiesPanel extends JPanel {
    ...
    private static class Renderer extends ToyboxTableCellRenderer {
        ...
        public Renderer() {
            super();
//            rendererIcon = getStandardCellLabel();
//            rendererFont = getStandardCellLabel();
//            rendererColor = getStandardCellLabel();
//
//            rendererColor.setHorizontalAlignment(SwingConstants.CENTER);
//            rendererIcon.setFont(rendererMonospaced.getFont());
        }
